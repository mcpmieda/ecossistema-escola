...
export interface LinkedStudentPhotoAvatarPropsV1 extends Pick<StudentPhotoAvatarPropsV1, 'size' | 'label' | 'className'> {
  subject: PhotoAdminSubjectV1;
  studentUid?: string;
  revision?: string | null;
}
export function LinkedStudentPhotoAvatarV1(props: Readonly<LinkedStudentPhotoAvatarPropsV1>) {
  return <LinkedAvatarSessionV1 key={photoSubjectKeyV1(props.subject)} {...props} />;
}
