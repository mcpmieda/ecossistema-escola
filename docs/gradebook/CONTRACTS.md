...
Boletins montado no shell usa V2 relacional da #654; Conselho usa V3 relacional; Relatórios usa V2 relacional da #656; a #658 usa somente diagnósticos atuais; a #660 conclui a configuração docente como leitura das ofertas importadas. Os contratos anteriores permanecem apenas como compatibilidade não montada quando ainda há consumidor; o write docente V1 e a UI/rota dedicada do Audit Workspace V1 não são mais servidos. O contexto fixo 2026 não converte consumidores restantes; apenas impede seleção divergente ou aproximada. Desempenho usa a projeção relacional V2/V3/V4. Ver [mapa](CONSUMER_MAP.md), [Configuração docente](RELATIONAL_TEACHER_CONFIGURATION_660.md), [Auditoria atual V2](RELATIONAL_CURRENT_AUDIT_V2.md), [retirada Audit V1](LEGACY_AUDIT_RETIREMENT_664.md), [Relatórios V2](RELATIONAL_REPORTS_V2.md), [Boletins V2](RELATIONAL_BULLETINS_V2.md), [Conselho V3](RELATIONAL_COUNCIL_V3.md), [contrato #646](FINAL2_SOURCE_DESKTOP_646.md) e [comparação #649](TERM_COMPARISON_2026_V4.md).
