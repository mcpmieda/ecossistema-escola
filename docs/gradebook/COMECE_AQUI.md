...
**#656 / PR #657**, branch `feat/bn-relational-reports-v2-656`. Base factual: `main@1512d5b37c42931b1df81bbfe6483d1ad5340130`, após Boletins V2 #654/PR #655, migration/postflight, merge, deploy 263 (`34572772095`) e smoke autenticado somente leitura. O trabalho atual existe no head da branch e só será fato integrado depois de CI, revisão, merge e deploy; `npm run verify` do head anterior à abertura da PR passou com 1.485 testes.
