...
**#660**, branch `fix/bn-teacher-settings-and-subject-order-660`. Base factual: `main@380b016d0c1ec5917323fe3fad35398b4fbd1a6a`, após Auditoria atual #658/PR #659, merge, deploy 265 (`34580485339`) e smoke autenticado somente leitura. O trabalho atual existe no head da branch e só será fato integrado depois de CI, revisão, merge, deploy e smoke.
