...
- **Integração concluída:** [#272 — décima onda](https://github.com/mcpmieda/ecossistema-escola/issues/272)
- **Integração atual:** [#281 — décima primeira onda](https://github.com/mcpmieda/ecossistema-escola/issues/281)
...
- **Ondas concluídas:** primeira à décima.
- **Onda atual:** #278, #279 e #280; integração #281.
...
| F5 — Contexto e centrais       | [#188](https://github.com/mcpmieda/ecossistema-escola/issues/188) | Contexto e entidades integrados; read models prontos |                2/7 | Aluno, turma, professor e componente   |
...
## Décima primeira onda — pronta

| Ordem serial |                                                             Issue | Entrega                                      | Agente recomendado                      |
| -----------: | ----------------------------------------------------------------: | -------------------------------------------- | --------------------------------------- |
|            1 | [#278](https://github.com/mcpmieda/ecossistema-escola/issues/278) | Read model local da Central do Aluno         | **Codex**                               |
|            2 | [#279](https://github.com/mcpmieda/ecossistema-escola/issues/279) | Read model local da Central da Turma         | **Codex**                               |
|            3 | [#280](https://github.com/mcpmieda/ecossistema-escola/issues/280) | Read models locais de Professor e Componente | **Codex**                               |
|            — | [#281](https://github.com/mcpmieda/ecossistema-escola/issues/281) | Composição, integração e próxima onda        | **Pro**; sem autorização atual ao Codex |
