...
Próximo bloco: fechar a #649/#650 pelos gates; a validação visual única permanece na #633/#634. Depois, manutenção docente, fontes relacionais de Boletins/Relatórios/Conselho e durabilidade seguem os contratos pertinentes; criação/gestão de anos e comparação entre anos foram retiradas. Piloto #406 e aceite #347 são próprios. Não reabrir a migração física nem criar base paralela. Integração/deploy seguem BN-DEC-023.

Referências: [Centrais V2](RELATIONAL_CENTERS_V2.md), [Desempenho V2](RELATIONAL_PERFORMANCE_V2.md), [fonte/desktop #646](FINAL2_SOURCE_DESKTOP_646.md), [comparação 2026 V4](TERM_COMPARISON_2026_V4.md), [baseline/Auditoria](CURRENT_SCHEMA_AND_DIAGNOSTICS.md), [segurança](SECURITY_REMEDIATION_637.md).
