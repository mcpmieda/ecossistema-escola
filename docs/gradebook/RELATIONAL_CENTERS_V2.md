...
Depois da #649, criação/gestão de anos não é mais requisito: o contexto é 2026. Conselho, Boletins, Relatórios, Auditoria atual e configuração docente relacionais foram integrados. A #662 comprovou recuperação do artefato e contenção local; ainda faltam durabilidade da trilha humana de Auditoria, recuperação operacional externa, validação visual conjunta e piloto integral. A #640/#649/#660/#662 não modificam regras do motor, dados ou autoridade acadêmica. #637/#641 tratam a remediação de dependências separadamente, com [relatório próprio](SECURITY_REMEDIATION_637.md).
