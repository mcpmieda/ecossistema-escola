...
Depois da #649, criação/gestão de anos não é mais requisito: o contexto é 2026. Conselho foi integrado na #653 e Boletins relacionais seguem na #654; ainda faltam manutenção docente, Audit Workspace antigo, Relatórios, validação visual conjunta e piloto integral. A #640 e a #649 não modificam regras do motor, schema, dados ou autoridade acadêmica. #637/#641 tratam a remediação de dependências separadamente, com [relatório próprio](SECURITY_REMEDIATION_637.md).
