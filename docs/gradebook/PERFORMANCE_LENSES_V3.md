...
Um gráfico por vez, conforme a lente. Categorias: no limite ou acima, abaixo da referência, leitura incompleta, N/C e sem máximo conhecido. Desde a #670, clicar na barra azul ou vermelha de um componente abre dentro do próprio widget as duas listas nominais daquele componente; a matriz principal não é filtrada por esse clique. Indicadores e faixas do panorama continuam podendo recortar a matriz, com identificação separada. “Ver mais” mostra população considerada, leituras com percentual, média e mediana proporcionais.

Quantitativo, Qualitativo e Avaliações usam somente leituras completas com máximo conhecido na classificação e na média/mediana. Na lente Resultado, uma soma numérica parcial já exibida é classificada pelo mesmo limite proporcional oficial de 60% — 18, 18 e 24 nos trimestres — sem alterar seu estado de cobertura; assim ela participa dos grupos e estatísticas do Resultado. **Zero real participa; ausência continua sem classificação e nunca vira zero.** Percentuais acima de 100% não são limitados silenciosamente. A classificação proporcional usa o limite anual configurado e o máximo do recorte definido pelo núcleo; descreve aquela leitura, não decide aprovação de uma avaliação, recuperação ou resultado final. Estatística de composição não substitui o resultado calculado.
