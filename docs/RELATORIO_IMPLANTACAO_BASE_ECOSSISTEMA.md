...
| `CLOUDFLARE_API_TOKEN`  | GitHub Environment Secret | deploy/rotação    | 2026-08-24 | sem expiração             | incidente/revogação | novo account token Pages Write         |
