...
1. Entre em **Painel do Aluno → Visão geral** e use **Atualizar visão geral**.
2. Confirme **Operando normalmente**, **População ativa** e **0 perfis ainda não criados**.
...
- jobs parados por mais de cinco minutos;
