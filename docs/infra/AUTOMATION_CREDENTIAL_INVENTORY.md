...
- Antigravity and Gemini CLI: removed. Their workflows and documentation are gone; `infra/agents/antigravity/run.py` stays because OpenHands Cloud still calls its `check` subcommand to validate handoffs.
