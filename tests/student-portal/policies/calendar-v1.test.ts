...
function policy(): ReturnType<typeof initialPolicyDefaultsV1> {
  ...
  return { ...defaults, accessEnabled: true, allowedPeriods: ['T1', 'T2', 'T3', 'REC1', 'REC2', 'REC3'],
    calendar: { ...defaults.calendar, yearStartsAt: '2026-01-01T00:00:00-03:00',
      t1EndsAt: '2026-05-16T00:00:00-03:00', t2StartsAt: '2026-05-18T00:00:00-03:00', t2EndsAt: '2026-09-01T00:00:00-03:00', t3StartsAt: '2026-09-01T00:00:00-03:00',
...
describe('calendar and session policy', () => {
  ...
  it('keeps legacy calendars readable while preferring separate term starts', () => {
    ...
    expect(periodDisclosureV1({ ...current, calendar: normalized }, 'T2', new Date('2026-05-16T03:00:00Z'))).toBe('allowed');
  });
