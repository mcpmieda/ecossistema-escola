...
/**
 * Exposes the four operational centers through the entity repository already selected by the UoW.
 * The facade only composes the existing queries; it does not add persistence access or rules.
 */
