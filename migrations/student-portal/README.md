...
| `0004_*` | reserved only for an additive correction proven necessary before #704 closes; do not create by default |
...
- `gradebook_app` receives only `EXECUTE` on `record_gradebook_change_v1`; it receives no general DML in `student_portal`.
