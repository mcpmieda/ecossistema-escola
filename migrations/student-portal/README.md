...
| `0018_shared_student_identity_v1.sql` | #1114: candidata, ainda não aplicada em produção; identidade durável compartilhada em `student_uid`, backfill por vínculos existentes, FKs e imutabilidade; preserva IDs, credenciais e referências de fotos |
