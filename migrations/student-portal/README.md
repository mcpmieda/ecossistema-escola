...
| `0019_remove_legacy_projection_v1.sql` | PR #1122 (aplicada e verificada tecnicamente em produção em 23/09/2026, versão `20260923164053`): após o deploy do Worker sem leitura legada e com V2 ativa, removeu `published_projection` e redefiniu `synchronize_profiles_v1` sem a exclusão dessa projeção. Os dados removidos não têm rollback por código. Evidência: `docs/student-portal/POSTFLIGHT_0019.md` |
